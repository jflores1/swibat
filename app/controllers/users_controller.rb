class UsersController < ApplicationController
  ...
  def remove_from_institution    
    ...
    if @member.save
      redirect_to institution_faculty_index_path(@institution), :notice => 'Faculty member removed.'
    else
      redirect_to institution_faculty_index_path(@institution), :notice => 'There was an error trying to remove the faculty member.'
    end
  end
